...
class ConcreteListing:
    ...
    ## PubSub pattern
    def on_state_change(self, callback: Callable[[ListingState], None]) -> None: 
        """Subscribe to state changes of this listing.""" 
        # TODO: implement this method, and add a way to store the callbacks in the listing. raise NotImplementedError()

    def unregister_on_state_change(self, callback: Callable[[ListingState], None]) -> None: 
        """Unsubscribe from state changes of this listing.""" 

    def __change_state(self, old_state: ListingState, new_state: ListingState) -> None: 
        """Change the state of this listing and notify subscribers.""" 
        self._state = new_state # TODO: notify subscribers of the state change. raise NotImplementedError()